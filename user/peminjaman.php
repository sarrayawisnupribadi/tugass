        ...
        <div class="card">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    where id_siswa = '".$_SESSION['id_siswa']."' ORDER BY id_peminjaman DESC");
                    $no=0;
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $query_detail = mysqli_query($koneksi, "SELECT * FROM detail_peminjaman_buku d
                                            ...
                                            id_peminjaman_buku = '".$data_peminjaman['id_peminjaman']."'");
                        ...
                        WHERE id_peminjaman_buku = '".$data_peminjaman['id_peminjaman']."'");
                        if (mysqli_num_rows($query_cek_kembali) > 0) {
                            ...
                            echo "<td><a href='kembali.php?id=".$data_peminjaman['id_peminjaman']."' class='btn btn-warning'
